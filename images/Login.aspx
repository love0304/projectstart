    ...
    <div class="wrapper">
        ...
        <div class="login">
            ...
            <div id="shows">
                ...
                ****************************************************
                ...
                <div class="glup">
                    ...
                    <span class="blank10"></span>
                    <p class="qkimg">
                        <a href="/login/wxlogin.aspx?http://login.vancl.com/login/Login.aspx?http://s.vancl.com/search?http%3A%2F%2Fs.vancl.com%2Fsearch%23ref%3Dhead-tcdl%7Chp-hp-head-nav_5-1-v%3An" id="a_wxlogin" class="weixin">
            ...
            <div class="user_infor" style="display: none">
                ...
                <p>
                    <label>
                        用户名：</label><input id="PartnerUserName" name="PartnerUserName" type="text" value="77fad5036ba443a3918e408f98ec6820" />
                </p>
